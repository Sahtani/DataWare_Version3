                ...
                ?>
                    <div class="mt-2 p-6 border rounded-lg shadow dark:bg-white">
                        ...
                        <div class="flex items-center justify-center gap-10">
                            ...
                            if ($arrayvalue['rol'] == 0) {
                            ?>
                                <a href="./updaterol.php?updaterol=<?= $arrayvalue['iduser'] ?>" class="inline-flex items-center px-5 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-dark dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                    Update
                                </a>
                            <?php
                            } else if ($arrayvalue['rol'] == 2) {
